...
def getWeather():
    try:
        ...
        #Weather
        api="https://api.openweathermap.org/data/2.5/weather?q="+city+"&appid=78738b80ee5bd2008874e5ff7b95878b"
...
#Bottom box
Frame_img = PhotoImage(file="../img/box.png")
